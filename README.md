...
print(detected_list) 
for itemm,caloriee in calPerItem.items():   #items() is a method used with dictionaries to access
...
#bby detections.cls[0] we access the conf of the detected object from the results.
